...
export default async function StarshipsPage({ searchParams }: Props) {
  ...
  const { data: allStarships, total, totalPages } = await getAllStarships(q, page);

  return (
    <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <PageHeader title="Starships" subtitle="Vessels of the Star Wars universe" count={total} />
      <div className="mb-6">
