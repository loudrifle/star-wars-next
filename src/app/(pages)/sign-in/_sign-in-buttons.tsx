  ...
  return (
    <div className="flex flex-col gap-3">
      <button
        ...
        className="w-full flex items-center justify-center gap-2 border border-[var(--color-sw-border)] text-[var(--color-sw-muted)] hover:border-[var(--color-sw-gold-dim)] hover:text-[var(--color-sw-gold)] transition-all px-4 py-3 rounded text-sm font-[var(--font-bebas)] tracking-wider cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {loading === "github" ? (
